...
memosCurrentApi.post("/auth/status", async (c) => {
  try {
    const context = await getRequestContext(c);
    return c.json({ user: await currentUserForContext(context) });
  } catch (error) {
...
memosCurrentApi.post("/auth/me", async (c) => {
  try {
    const context = await getRequestContext(c);
    return c.json({ user: await currentUserForContext(context) });
  } catch (error) {
...
memosCurrentApi.get("/auth:getCurrentUser", async (c) => {
  try {
    const context = await getRequestContext(c);
    return c.json({ user: await currentUserForContext(context) });
  } catch (error) {
...
memosCurrentApi.post("/auth:getCurrentUser", async (c) => {
  try {
    const context = await getRequestContext(c);
    return c.json({ user: await currentUserForContext(context) });
  } catch (error) {
...
memosCurrentApi.get("/auth/currentUser", async (c) => {
  try {
    const context = await getRequestContext(c);
    return c.json({ user: await currentUserForContext(context) });
  } catch (error) {
...
memosCurrentApi.post("/auth/currentUser", async (c) => {
  try {
    const context = await getRequestContext(c);
    return c.json({ user: await currentUserForContext(context) });
  } catch (error) {
